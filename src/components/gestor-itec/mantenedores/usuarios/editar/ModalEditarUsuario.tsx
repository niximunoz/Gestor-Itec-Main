...
import CtrlModalEditarUsuario from './CtrlModalEditarUsuario'
...
export const ModalEditarUsuario = ({ recargar,data}: Props) => {
  const {
    Transition,
    schemaUsuario,
    loading,
  ...
  return (
    <>
      ...
      >
        <form onSubmit={handleSubmit((data : IFormInputs) => actualizarUsuario(data, reset))}>
              ...
              <Grid container spacing={5}>
                <Grid item xs={12} sm={4}>
                  <Controller
                    name='UsuRut'
                    control={control}
                    defaultValue={data.UsuRut.toString()}
